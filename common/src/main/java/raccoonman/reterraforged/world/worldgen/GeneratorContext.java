...
public class GeneratorContext {
    ...
    public GeneratorContext(WorldPreset preset, HolderGetter<Noise> noiseLookup, int seed, int tileSize, int tileBorder, int batchCount, @Nullable TileCache cache) {
        this.preset = preset;
    ...
    public static GeneratorContext makeCached(WorldPreset preset, HolderGetter<Noise> noiseLookup, int seed, int tileSize, int batchCount, boolean queue) {
    ...
    public static GeneratorContext makeUncached(WorldPreset preset, HolderGetter<Noise> noiseLookup, int seed, int tileSize, int tileBorder, int batchCount) {
