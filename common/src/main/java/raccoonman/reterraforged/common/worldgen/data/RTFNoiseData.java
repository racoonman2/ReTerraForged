...
//
//// give each terrain a base erosion and ridge offset
...
//	public static final ResourceKey<Noise> REGION_ID = createKey("region_id");
//	public static final ResourceKey<Noise> TERRAIN_TYPE = createKey("terrain_type");
...
//        Noise regionId = register(ctx, REGION_ID, makeRegionId(regionWarp, regionFrequency));
//        
