...
public record SingleContinent(Domain warp, float frequency, float offsetAlpha, DistanceFunction distanceFunc, float clampMin, float clampMax, float inlandPoint, Noise shape) implements Noise, BaseContinent {
