...
import raccoonman.reterraforged.common.level.levelgen.biome.source.ClimateBiomeSource;
		...
		return new WorldPreset(
			...
			.put(LevelStem.OVERWORLD, 
				new LevelStem(
					...
					new NoiseBasedChunkGenerator(
						new ClimateBiomeSource(climatePreset.getOrThrow(RTFClimatePresets.DEFAULT)),
