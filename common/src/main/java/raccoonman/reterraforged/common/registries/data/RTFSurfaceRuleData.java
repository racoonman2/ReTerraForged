...
import raccoonman.reterraforged.common.level.levelgen.surface.StrataCondition;
...
public class RTFSurfaceRuleData {
    ...
    private static final SurfaceRules.RuleSource ANDESITE = RTFSurfaceRuleData.makeStateRule(Blocks.ANDESITE);
    ...
    public static SurfaceRules.RuleSource overworldLike(boolean bl, boolean bl2, boolean bl3) {
        ...
        SurfaceRules.RuleSource ruleSource4 = SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.STONY_PEAKS), SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.CALCITE, -0.0125, 0.0125), CALCITE), STONE)), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.STONY_SHORE), SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.GRAVEL, -0.05, 0.05), ruleSource3), STONE)), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.WINDSWEPT_HILLS), SurfaceRules.ifTrue(RTFSurfaceRuleData.surfaceNoiseAbove(1.0), STONE)), SurfaceRules.ifTrue(conditionSource14, ruleSource2), SurfaceRules.ifTrue(conditionSource15, ruleSource2), SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.DRIPSTONE_CAVES), STONE));
...
//        builder.add(SurfaceRules.ifTrue(new StrataCondition()));
