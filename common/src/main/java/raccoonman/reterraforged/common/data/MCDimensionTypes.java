...
public final class MCDimensionTypes {
	...
	public static void bootstrap(BootstapContext<DimensionType> ctx, Preset preset) {
		...
		ctx.register(BuiltinDimensionTypes.OVERWORLD, new DimensionType(OptionalLong.empty(), true, false, false, true, 1.0D, true, false, properties.minY, properties.worldHeight, properties.worldHeight, BlockTags.INFINIBURN_OVERWORLD, BuiltinDimensionTypes.OVERWORLD_EFFECTS, 0.0F, new DimensionType.MonsterSettings(false, true, UniformInt.of(0, 7), 0)));
    }
}
