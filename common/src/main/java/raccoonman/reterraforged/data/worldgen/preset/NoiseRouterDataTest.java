...
public class NoiseRouterDataTest {
    ...
    private static final ResourceKey<DensityFunction> ZERO = NoiseRouterDataTest.createKey("zero");
    public static final ResourceKey<DensityFunction> Y = NoiseRouterDataTest.createKey("y");
    private static final ResourceKey<DensityFunction> SHIFT_X = NoiseRouterDataTest.createKey("shift_x");
    private static final ResourceKey<DensityFunction> SHIFT_Z = NoiseRouterDataTest.createKey("shift_z");
    public static final ResourceKey<DensityFunction> BASE_3D_NOISE_OVERWORLD = NoiseRouterDataTest.createKey("overworld/base_3d_noise");
    private static final ResourceKey<DensityFunction> BASE_3D_NOISE_NETHER = NoiseRouterDataTest.createKey("nether/base_3d_noise");
    private static final ResourceKey<DensityFunction> BASE_3D_NOISE_END = NoiseRouterDataTest.createKey("end/base_3d_noise");
    public static final ResourceKey<DensityFunction> CONTINENTS = NoiseRouterDataTest.createKey("overworld/continents");
    public static final ResourceKey<DensityFunction> EROSION = NoiseRouterDataTest.createKey("overworld/erosion");
    public static final ResourceKey<DensityFunction> RIDGES = NoiseRouterDataTest.createKey("overworld/ridges");
    public static final ResourceKey<DensityFunction> RIDGES_FOLDED = NoiseRouterDataTest.createKey("overworld/ridges_folded");
    public static final ResourceKey<DensityFunction> OFFSET = NoiseRouterDataTest.createKey("overworld/offset");
    public static final ResourceKey<DensityFunction> FACTOR = NoiseRouterDataTest.createKey("overworld/factor");
    public static final ResourceKey<DensityFunction> JAGGEDNESS = NoiseRouterDataTest.createKey("overworld/jaggedness");
    public static final ResourceKey<DensityFunction> DEPTH = NoiseRouterDataTest.createKey("overworld/depth");
    public static final ResourceKey<DensityFunction> SLOPED_CHEESE = NoiseRouterDataTest.createKey("overworld/sloped_cheese");
    public static final ResourceKey<DensityFunction> CONTINENTS_LARGE = NoiseRouterDataTest.createKey("overworld_large_biomes/continents");
    public static final ResourceKey<DensityFunction> EROSION_LARGE = NoiseRouterDataTest.createKey("overworld_large_biomes/erosion");
    private static final ResourceKey<DensityFunction> OFFSET_LARGE = NoiseRouterDataTest.createKey("overworld_large_biomes/offset");
    private static final ResourceKey<DensityFunction> FACTOR_LARGE = NoiseRouterDataTest.createKey("overworld_large_biomes/factor");
    private static final ResourceKey<DensityFunction> JAGGEDNESS_LARGE = NoiseRouterDataTest.createKey("overworld_large_biomes/jaggedness");
    private static final ResourceKey<DensityFunction> DEPTH_LARGE = NoiseRouterDataTest.createKey("overworld_large_biomes/depth");
    private static final ResourceKey<DensityFunction> SLOPED_CHEESE_LARGE = NoiseRouterDataTest.createKey("overworld_large_biomes/sloped_cheese");
    private static final ResourceKey<DensityFunction> OFFSET_AMPLIFIED = NoiseRouterDataTest.createKey("overworld_amplified/offset");
    private static final ResourceKey<DensityFunction> FACTOR_AMPLIFIED = NoiseRouterDataTest.createKey("overworld_amplified/factor");
    private static final ResourceKey<DensityFunction> JAGGEDNESS_AMPLIFIED = NoiseRouterDataTest.createKey("overworld_amplified/jaggedness");
    private static final ResourceKey<DensityFunction> DEPTH_AMPLIFIED = NoiseRouterDataTest.createKey("overworld_amplified/depth");
    private static final ResourceKey<DensityFunction> SLOPED_CHEESE_AMPLIFIED = NoiseRouterDataTest.createKey("overworld_amplified/sloped_cheese");
    private static final ResourceKey<DensityFunction> SLOPED_CHEESE_END = NoiseRouterDataTest.createKey("end/sloped_cheese");
    public static final ResourceKey<DensityFunction> SPAGHETTI_ROUGHNESS_FUNCTION = NoiseRouterDataTest.createKey("overworld/caves/spaghetti_roughness_function");
    public static final ResourceKey<DensityFunction> ENTRANCES = NoiseRouterDataTest.createKey("overworld/caves/entrances");
    public static final ResourceKey<DensityFunction> NOODLE = NoiseRouterDataTest.createKey("overworld/caves/noodle");
    public static final ResourceKey<DensityFunction> PILLARS = NoiseRouterDataTest.createKey("overworld/caves/pillars");
    public static final ResourceKey<DensityFunction> SPAGHETTI_2D_THICKNESS_MODULATOR = NoiseRouterDataTest.createKey("overworld/caves/spaghetti_2d_thickness_modulator");
    public static final ResourceKey<DensityFunction> SPAGHETTI_2D = NoiseRouterDataTest.createKey("overworld/caves/spaghetti_2d");
    ...
    public static Holder<? extends DensityFunction> bootstrap(BootstapContext<DensityFunction> bootstapContext) {
        ...
        DensityFunction densityFunction = NoiseRouterDataTest.registerAndWrap(bootstapContext, SHIFT_X, DensityFunctions.flatCache(DensityFunctions.cache2d(DensityFunctions.shiftA(holderGetter.getOrThrow(Noises.SHIFT)))));
        DensityFunction densityFunction2 = NoiseRouterDataTest.registerAndWrap(bootstapContext, SHIFT_Z, DensityFunctions.flatCache(DensityFunctions.cache2d(DensityFunctions.shiftB(holderGetter.getOrThrow(Noises.SHIFT)))));
        ...
        DensityFunction densityFunction3 = NoiseRouterDataTest.registerAndWrap(bootstapContext, RIDGES, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(densityFunction, densityFunction2, 0.25, holderGetter.getOrThrow(Noises.RIDGE))));
        bootstapContext.register(RIDGES_FOLDED, NoiseRouterDataTest.peaksAndValleys(densityFunction3));
        DensityFunction densityFunction4 = DensityFunctions.noise(holderGetter.getOrThrow(Noises.JAGGED), 1500.0, 0.0);
        NoiseRouterDataTest.registerTerrainNoises(bootstapContext, holderGetter2, densityFunction4, holder, holder2, OFFSET, FACTOR, JAGGEDNESS, DEPTH, SLOPED_CHEESE, false);
        ...
        NoiseRouterDataTest.registerTerrainNoises(bootstapContext, holderGetter2, densityFunction4, holder3, holder4, OFFSET_LARGE, FACTOR_LARGE, JAGGEDNESS_LARGE, DEPTH_LARGE, SLOPED_CHEESE_LARGE, false);
        NoiseRouterDataTest.registerTerrainNoises(bootstapContext, holderGetter2, densityFunction4, holder, holder2, OFFSET_AMPLIFIED, FACTOR_AMPLIFIED, JAGGEDNESS_AMPLIFIED, DEPTH_AMPLIFIED, SLOPED_CHEESE_AMPLIFIED, true);
        bootstapContext.register(SLOPED_CHEESE_END, DensityFunctions.add(DensityFunctions.endIslands(0L), NoiseRouterDataTest.getFunction(holderGetter2, BASE_3D_NOISE_END)));
        bootstapContext.register(SPAGHETTI_ROUGHNESS_FUNCTION, NoiseRouterDataTest.spaghettiRoughnessFunction(holderGetter));
        ...
        bootstapContext.register(SPAGHETTI_2D, NoiseRouterDataTest.spaghetti2D(holderGetter2, holderGetter));
        bootstapContext.register(ENTRANCES, NoiseRouterDataTest.entrances(holderGetter2, holderGetter));
        bootstapContext.register(NOODLE, NoiseRouterDataTest.noodle(holderGetter2, holderGetter));
        return bootstapContext.register(PILLARS, NoiseRouterDataTest.pillars(holderGetter));
    }
    ...
    private static void registerTerrainNoises(BootstapContext<DensityFunction> bootstapContext, HolderGetter<DensityFunction> holderGetter, DensityFunction densityFunction, Holder<DensityFunction> holder, Holder<DensityFunction> holder2, ResourceKey<DensityFunction> resourceKey, ResourceKey<DensityFunction> resourceKey2, ResourceKey<DensityFunction> resourceKey3, ResourceKey<DensityFunction> resourceKey4, ResourceKey<DensityFunction> resourceKey5, boolean bl) {
        ...
        DensityFunction densityFunction2 = NoiseRouterDataTest.registerAndWrap(bootstapContext, resourceKey, NoiseRouterDataTest.splineWithBlending(DensityFunctions.add(DensityFunctions.constant(-0.50375f), DensityFunctions.spline(TerrainProvider.overworldOffset(coordinate, coordinate2, coordinate4, bl))), DensityFunctions.blendOffset()));
        DensityFunction densityFunction3 = NoiseRouterDataTest.registerAndWrap(bootstapContext, resourceKey2, NoiseRouterDataTest.splineWithBlending(DensityFunctions.spline(TerrainProvider.overworldFactor(coordinate, coordinate2, coordinate3, coordinate4, bl)), BLENDING_FACTOR));
        DensityFunction densityFunction4 = NoiseRouterDataTest.registerAndWrap(bootstapContext, resourceKey4, DensityFunctions.add(DensityFunctions.yClampedGradient(-64, 320, 1.5, -1.5), densityFunction2));
        DensityFunction densityFunction5 = NoiseRouterDataTest.registerAndWrap(bootstapContext, resourceKey3, NoiseRouterDataTest.splineWithBlending(DensityFunctions.spline(TerrainProvider.overworldJaggedness(coordinate, coordinate2, coordinate3, coordinate4, bl)), BLENDING_JAGGEDNESS));
        DensityFunction densityFunction6 = DensityFunctions.mul(densityFunction5, densityFunction.halfNegative());
        DensityFunction densityFunction7 = NoiseRouterDataTest.noiseGradientDensity(densityFunction3, DensityFunctions.add(densityFunction4, densityFunction6));
        bootstapContext.register(resourceKey5, DensityFunctions.add(densityFunction7, NoiseRouterDataTest.getFunction(holderGetter, BASE_3D_NOISE_OVERWORLD)));
    }
    ...
    public static DensityFunction entrances(HolderGetter<DensityFunction> holderGetter, HolderGetter<NormalNoise.NoiseParameters> holderGetter2) {
        ...
        DensityFunction densityFunction6 = NoiseRouterDataTest.getFunction(holderGetter, SPAGHETTI_ROUGHNESS_FUNCTION);
    ...
    private static DensityFunction noodle(HolderGetter<DensityFunction> holderGetter, HolderGetter<NormalNoise.NoiseParameters> holderGetter2) {
        DensityFunction densityFunction = NoiseRouterDataTest.getFunction(holderGetter, Y);
        int i = -64;
        int j = -60;
        int k = 320;
        DensityFunction densityFunction2 = NoiseRouterDataTest.yLimitedInterpolatable(densityFunction, DensityFunctions.noise(holderGetter2.getOrThrow(Noises.NOODLE), 1.0, 1.0), -60, 320, -1);
        DensityFunction densityFunction3 = NoiseRouterDataTest.yLimitedInterpolatable(densityFunction, DensityFunctions.mappedNoise(holderGetter2.getOrThrow(Noises.NOODLE_THICKNESS), 1.0, 1.0, -0.05, -0.1), -60, 320, 0);
        double d = 2.6666666666666665;
        DensityFunction densityFunction4 = NoiseRouterDataTest.yLimitedInterpolatable(densityFunction, DensityFunctions.noise(holderGetter2.getOrThrow(Noises.NOODLE_RIDGE_A), 2.6666666666666665, 2.6666666666666665), -60, 320, 0);
        DensityFunction densityFunction5 = NoiseRouterDataTest.yLimitedInterpolatable(densityFunction, DensityFunctions.noise(holderGetter2.getOrThrow(Noises.NOODLE_RIDGE_B), 2.6666666666666665, 2.6666666666666665), -60, 320, 0);
    ...
    private static DensityFunction spaghetti2D(HolderGetter<DensityFunction> holderGetter, HolderGetter<NormalNoise.NoiseParameters> holderGetter2) {
        ...
        DensityFunction densityFunction4 = NoiseRouterDataTest.getFunction(holderGetter, SPAGHETTI_2D_THICKNESS_MODULATOR);
    ...
    public static DensityFunction underground(HolderGetter<DensityFunction> holderGetter, HolderGetter<NormalNoise.NoiseParameters> holderGetter2, DensityFunction densityFunction) {
        DensityFunction densityFunction2 = NoiseRouterDataTest.getFunction(holderGetter, SPAGHETTI_2D);
        DensityFunction densityFunction3 = NoiseRouterDataTest.getFunction(holderGetter, SPAGHETTI_ROUGHNESS_FUNCTION);
        ...
        DensityFunction densityFunction9 = DensityFunctions.min(DensityFunctions.min(densityFunction8, NoiseRouterDataTest.getFunction(holderGetter, ENTRANCES)), DensityFunctions.add(densityFunction2, densityFunction3));
        DensityFunction densityFunction10 = NoiseRouterDataTest.getFunction(holderGetter, PILLARS);
    ...
    protected static NoiseRouter overworld(HolderGetter<DensityFunction> holderGetter, HolderGetter<NormalNoise.NoiseParameters> holderGetter2, boolean bl, boolean bl2) {
        ...
        DensityFunction densityFunction5 = NoiseRouterDataTest.getFunction(holderGetter, SHIFT_X);
        DensityFunction densityFunction6 = NoiseRouterDataTest.getFunction(holderGetter, SHIFT_Z);
        ...
        DensityFunction densityFunction9 = NoiseRouterDataTest.getFunction(holderGetter, bl ? FACTOR_LARGE : (bl2 ? FACTOR_AMPLIFIED : FACTOR));
        DensityFunction densityFunction10 = NoiseRouterDataTest.getFunction(holderGetter, bl ? DEPTH_LARGE : (bl2 ? DEPTH_AMPLIFIED : DEPTH));
        DensityFunction densityFunction11 = NoiseRouterDataTest.noiseGradientDensity(DensityFunctions.cache2d(densityFunction9), densityFunction10);
        DensityFunction densityFunction12 = NoiseRouterDataTest.getFunction(holderGetter, bl ? SLOPED_CHEESE_LARGE : (bl2 ? SLOPED_CHEESE_AMPLIFIED : SLOPED_CHEESE));
        DensityFunction densityFunction13 = DensityFunctions.min(densityFunction12, DensityFunctions.mul(DensityFunctions.constant(5.0), NoiseRouterDataTest.getFunction(holderGetter, ENTRANCES)));
        DensityFunction densityFunction14 = DensityFunctions.rangeChoice(densityFunction12, -1000000.0, 1.5625, densityFunction13, NoiseRouterDataTest.underground(holderGetter, holderGetter2, densityFunction12));
        DensityFunction densityFunction15 = DensityFunctions.min(NoiseRouterDataTest.postProcess(NoiseRouterDataTest.slideOverworld(bl2, densityFunction14)), NoiseRouterDataTest.getFunction(holderGetter, NOODLE));
        DensityFunction densityFunction16 = NoiseRouterDataTest.getFunction(holderGetter, Y);
        ...
        DensityFunction densityFunction17 = NoiseRouterDataTest.yLimitedInterpolatable(densityFunction16, DensityFunctions.noise(holderGetter2.getOrThrow(Noises.ORE_VEININESS), 1.5, 1.5), i, j, 0);
        float f = 4.0f;
        DensityFunction densityFunction18 = NoiseRouterDataTest.yLimitedInterpolatable(densityFunction16, DensityFunctions.noise(holderGetter2.getOrThrow(Noises.ORE_VEIN_A), 4.0, 4.0), i, j, 0).abs();
        DensityFunction densityFunction19 = NoiseRouterDataTest.yLimitedInterpolatable(densityFunction16, DensityFunctions.noise(holderGetter2.getOrThrow(Noises.ORE_VEIN_B), 4.0, 4.0), i, j, 0).abs();
        ...
        return new NoiseRouter(densityFunction, densityFunction2, densityFunction3, densityFunction4, densityFunction7, densityFunction8, NoiseRouterDataTest.getFunction(holderGetter, bl ? CONTINENTS_LARGE : CONTINENTS), NoiseRouterDataTest.getFunction(holderGetter, bl ? EROSION_LARGE : EROSION), densityFunction10, NoiseRouterDataTest.getFunction(holderGetter, RIDGES), NoiseRouterDataTest.slideOverworld(bl2, DensityFunctions.add(densityFunction11, DensityFunctions.constant(-0.703125)).clamp(-64.0, 64.0)), densityFunction15, densityFunction17, densityFunction20, densityFunction21);
    }
    ...
    private static NoiseRouter noNewCaves(HolderGetter<DensityFunction> holderGetter, HolderGetter<NormalNoise.NoiseParameters> holderGetter2, DensityFunction densityFunction) {
        DensityFunction densityFunction2 = NoiseRouterDataTest.getFunction(holderGetter, SHIFT_X);
        DensityFunction densityFunction3 = NoiseRouterDataTest.getFunction(holderGetter, SHIFT_Z);
        ...
        DensityFunction densityFunction6 = NoiseRouterDataTest.postProcess(densityFunction);
    ...
    private static DensityFunction slideOverworld(boolean bl, DensityFunction densityFunction) {
        return NoiseRouterDataTest.slide(densityFunction, -64, 384, bl ? 16 : 80, bl ? 0 : 64, -0.078125, 0, 24, bl ? 0.4 : 0.1171875);
    }

    private static DensityFunction slideNetherLike(HolderGetter<DensityFunction> holderGetter, int i, int j) {
        return NoiseRouterDataTest.slide(NoiseRouterDataTest.getFunction(holderGetter, BASE_3D_NOISE_NETHER), i, j, 24, 0, 0.9375, -8, 24, 2.5);
    }

    private static DensityFunction slideEndLike(DensityFunction densityFunction, int i, int j) {
        return NoiseRouterDataTest.slide(densityFunction, i, j, 72, -184, -23.4375, 4, 32, -0.234375);
    }
    ...
    protected static NoiseRouter nether(HolderGetter<DensityFunction> holderGetter, HolderGetter<NormalNoise.NoiseParameters> holderGetter2) {
        return NoiseRouterDataTest.noNewCaves(holderGetter, holderGetter2, NoiseRouterDataTest.slideNetherLike(holderGetter, 0, 128));
    }
    ...
    protected static NoiseRouter caves(HolderGetter<DensityFunction> holderGetter, HolderGetter<NormalNoise.NoiseParameters> holderGetter2) {
        return NoiseRouterDataTest.noNewCaves(holderGetter, holderGetter2, NoiseRouterDataTest.slideNetherLike(holderGetter, -64, 192));
    }
    ...
    protected static NoiseRouter floatingIslands(HolderGetter<DensityFunction> holderGetter, HolderGetter<NormalNoise.NoiseParameters> holderGetter2) {
        return NoiseRouterDataTest.noNewCaves(holderGetter, holderGetter2, NoiseRouterDataTest.slideEndLike(NoiseRouterDataTest.getFunction(holderGetter, BASE_3D_NOISE_END), 0, 256));
    }

    private static DensityFunction slideEnd(DensityFunction densityFunction) {
        return NoiseRouterDataTest.slideEndLike(densityFunction, 0, 128);
    }
    ...
    protected static NoiseRouter end(HolderGetter<DensityFunction> holderGetter) {
        ...
        DensityFunction densityFunction2 = NoiseRouterDataTest.postProcess(NoiseRouterDataTest.slideEnd(NoiseRouterDataTest.getFunction(holderGetter, SLOPED_CHEESE_END)));
        return new NoiseRouter(DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), densityFunction, DensityFunctions.zero(), DensityFunctions.zero(), NoiseRouterDataTest.slideEnd(DensityFunctions.add(densityFunction, DensityFunctions.constant(-0.703125))), densityFunction2, DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero());
    }
