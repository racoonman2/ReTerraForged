...
public class TerrainProvider {
    ...
    private static <C, I extends ToFloatFunction<C>> CubicSpline<C, I> getErosionFactor(I erosion, I weirdness, I peaksAndValleys, float baseFactor, boolean coastal) {
        ...
        if (coastal) {
            ...
            CubicSpline<C, I> river = CubicSpline.builder(peaksAndValleys)
            ...
            CubicSpline<C, I> riverBanks = CubicSpline.builder(peaksAndValleys)
            	...
            	.build();
            builder
            	.addPoint(0.05f, riverBanks)
            	.addPoint(0.4f, riverBanks)
            	.addPoint(0.45f, river)
            	.addPoint(0.55f, river)
