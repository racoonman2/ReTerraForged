...
public class PresetPlacedFeatures {
	...
	public static void bootstrap(Preset preset, BootstapContext<PlacedFeature> ctx) {
        ...
        if(miscellaneous.customBiomeFeatures) {
            ...
            PlacementUtils.register(ctx, BIRCH_GRASS, features.getOrThrow(PresetConfiguredFeatures.BIRCH_GRASS), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, CountPlacement.of(7));
            PlacementUtils.register(ctx, BIRCH_BUSH, features.getOrThrow(PresetConfiguredFeatures.BIRCH_BUSH), RTFPlacementModifiers.countExtra(0, 0.05F, 1), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome());
