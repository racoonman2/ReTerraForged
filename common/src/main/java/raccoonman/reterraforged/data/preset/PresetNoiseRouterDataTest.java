...
public class PresetNoiseRouterDataTest {
    ...
    private static final ResourceKey<DensityFunction> ZERO = PresetNoiseRouterDataTest.createKey("zero");
    public static final ResourceKey<DensityFunction> Y = PresetNoiseRouterDataTest.createKey("y");
    private static final ResourceKey<DensityFunction> SHIFT_X = PresetNoiseRouterDataTest.createKey("shift_x");
    private static final ResourceKey<DensityFunction> SHIFT_Z = PresetNoiseRouterDataTest.createKey("shift_z");
    public static final ResourceKey<DensityFunction> BASE_3D_NOISE_OVERWORLD = PresetNoiseRouterDataTest.createKey("overworld/base_3d_noise");
    private static final ResourceKey<DensityFunction> BASE_3D_NOISE_NETHER = PresetNoiseRouterDataTest.createKey("nether/base_3d_noise");
    private static final ResourceKey<DensityFunction> BASE_3D_NOISE_END = PresetNoiseRouterDataTest.createKey("end/base_3d_noise");
    public static final ResourceKey<DensityFunction> CONTINENTS = PresetNoiseRouterDataTest.createKey("overworld/continents");
    public static final ResourceKey<DensityFunction> EROSION = PresetNoiseRouterDataTest.createKey("overworld/erosion");
    public static final ResourceKey<DensityFunction> RIDGES = PresetNoiseRouterDataTest.createKey("overworld/ridges");
    public static final ResourceKey<DensityFunction> RIDGES_FOLDED = PresetNoiseRouterDataTest.createKey("overworld/ridges_folded");
    public static final ResourceKey<DensityFunction> OFFSET = PresetNoiseRouterDataTest.createKey("overworld/offset");
    public static final ResourceKey<DensityFunction> FACTOR = PresetNoiseRouterDataTest.createKey("overworld/factor");
    public static final ResourceKey<DensityFunction> JAGGEDNESS = PresetNoiseRouterDataTest.createKey("overworld/jaggedness");
    public static final ResourceKey<DensityFunction> DEPTH = PresetNoiseRouterDataTest.createKey("overworld/depth");
    public static final ResourceKey<DensityFunction> SLOPED_CHEESE = PresetNoiseRouterDataTest.createKey("overworld/sloped_cheese");
    public static final ResourceKey<DensityFunction> CONTINENTS_LARGE = PresetNoiseRouterDataTest.createKey("overworld_large_biomes/continents");
    public static final ResourceKey<DensityFunction> EROSION_LARGE = PresetNoiseRouterDataTest.createKey("overworld_large_biomes/erosion");
    private static final ResourceKey<DensityFunction> OFFSET_LARGE = PresetNoiseRouterDataTest.createKey("overworld_large_biomes/offset");
    private static final ResourceKey<DensityFunction> FACTOR_LARGE = PresetNoiseRouterDataTest.createKey("overworld_large_biomes/factor");
    private static final ResourceKey<DensityFunction> JAGGEDNESS_LARGE = PresetNoiseRouterDataTest.createKey("overworld_large_biomes/jaggedness");
    private static final ResourceKey<DensityFunction> DEPTH_LARGE = PresetNoiseRouterDataTest.createKey("overworld_large_biomes/depth");
    private static final ResourceKey<DensityFunction> SLOPED_CHEESE_LARGE = PresetNoiseRouterDataTest.createKey("overworld_large_biomes/sloped_cheese");
    private static final ResourceKey<DensityFunction> OFFSET_AMPLIFIED = PresetNoiseRouterDataTest.createKey("overworld_amplified/offset");
    private static final ResourceKey<DensityFunction> FACTOR_AMPLIFIED = PresetNoiseRouterDataTest.createKey("overworld_amplified/factor");
    private static final ResourceKey<DensityFunction> JAGGEDNESS_AMPLIFIED = PresetNoiseRouterDataTest.createKey("overworld_amplified/jaggedness");
    private static final ResourceKey<DensityFunction> DEPTH_AMPLIFIED = PresetNoiseRouterDataTest.createKey("overworld_amplified/depth");
    private static final ResourceKey<DensityFunction> SLOPED_CHEESE_AMPLIFIED = PresetNoiseRouterDataTest.createKey("overworld_amplified/sloped_cheese");
    private static final ResourceKey<DensityFunction> SLOPED_CHEESE_END = PresetNoiseRouterDataTest.createKey("end/sloped_cheese");
    public static final ResourceKey<DensityFunction> SPAGHETTI_ROUGHNESS_FUNCTION = PresetNoiseRouterDataTest.createKey("overworld/caves/spaghetti_roughness_function");
    public static final ResourceKey<DensityFunction> ENTRANCES = PresetNoiseRouterDataTest.createKey("overworld/caves/entrances");
    public static final ResourceKey<DensityFunction> NOODLE = PresetNoiseRouterDataTest.createKey("overworld/caves/noodle");
    public static final ResourceKey<DensityFunction> PILLARS = PresetNoiseRouterDataTest.createKey("overworld/caves/pillars");
    public static final ResourceKey<DensityFunction> SPAGHETTI_2D_THICKNESS_MODULATOR = PresetNoiseRouterDataTest.createKey("overworld/caves/spaghetti_2d_thickness_modulator");
    public static final ResourceKey<DensityFunction> SPAGHETTI_2D = PresetNoiseRouterDataTest.createKey("overworld/caves/spaghetti_2d");
    ...
    public static Holder<? extends DensityFunction> bootstrap(BootstapContext<DensityFunction> bootstapContext) {
        ...
        DensityFunction densityFunction = PresetNoiseRouterDataTest.registerAndWrap(bootstapContext, SHIFT_X, DensityFunctions.flatCache(DensityFunctions.cache2d(DensityFunctions.shiftA(holderGetter.getOrThrow(Noises.SHIFT)))));
        DensityFunction densityFunction2 = PresetNoiseRouterDataTest.registerAndWrap(bootstapContext, SHIFT_Z, DensityFunctions.flatCache(DensityFunctions.cache2d(DensityFunctions.shiftB(holderGetter.getOrThrow(Noises.SHIFT)))));
        ...
        DensityFunction densityFunction3 = PresetNoiseRouterDataTest.registerAndWrap(bootstapContext, RIDGES, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(densityFunction, densityFunction2, 0.25, holderGetter.getOrThrow(Noises.RIDGE))));
        bootstapContext.register(RIDGES_FOLDED, PresetNoiseRouterDataTest.peaksAndValleys(densityFunction3));
        DensityFunction densityFunction4 = DensityFunctions.noise(holderGetter.getOrThrow(Noises.JAGGED), 1500.0, 0.0);
        PresetNoiseRouterDataTest.registerTerrainNoises(bootstapContext, holderGetter2, densityFunction4, holder, holder2, OFFSET, FACTOR, JAGGEDNESS, DEPTH, SLOPED_CHEESE, false);
        ...
        PresetNoiseRouterDataTest.registerTerrainNoises(bootstapContext, holderGetter2, densityFunction4, holder3, holder4, OFFSET_LARGE, FACTOR_LARGE, JAGGEDNESS_LARGE, DEPTH_LARGE, SLOPED_CHEESE_LARGE, false);
        PresetNoiseRouterDataTest.registerTerrainNoises(bootstapContext, holderGetter2, densityFunction4, holder, holder2, OFFSET_AMPLIFIED, FACTOR_AMPLIFIED, JAGGEDNESS_AMPLIFIED, DEPTH_AMPLIFIED, SLOPED_CHEESE_AMPLIFIED, true);
        bootstapContext.register(SLOPED_CHEESE_END, DensityFunctions.add(DensityFunctions.endIslands(0L), PresetNoiseRouterDataTest.getFunction(holderGetter2, BASE_3D_NOISE_END)));
        bootstapContext.register(SPAGHETTI_ROUGHNESS_FUNCTION, PresetNoiseRouterDataTest.spaghettiRoughnessFunction(holderGetter));
        ...
        bootstapContext.register(SPAGHETTI_2D, PresetNoiseRouterDataTest.spaghetti2D(holderGetter2, holderGetter));
        bootstapContext.register(ENTRANCES, PresetNoiseRouterDataTest.entrances(holderGetter2, holderGetter));
        bootstapContext.register(NOODLE, PresetNoiseRouterDataTest.noodle(holderGetter2, holderGetter));
        return bootstapContext.register(PILLARS, PresetNoiseRouterDataTest.pillars(holderGetter));
    }
    ...
    private static void registerTerrainNoises(BootstapContext<DensityFunction> bootstapContext, HolderGetter<DensityFunction> holderGetter, DensityFunction densityFunction, Holder<DensityFunction> holder, Holder<DensityFunction> holder2, ResourceKey<DensityFunction> resourceKey, ResourceKey<DensityFunction> resourceKey2, ResourceKey<DensityFunction> resourceKey3, ResourceKey<DensityFunction> resourceKey4, ResourceKey<DensityFunction> resourceKey5, boolean bl) {
        ...
        DensityFunction densityFunction2 = PresetNoiseRouterDataTest.registerAndWrap(bootstapContext, resourceKey, PresetNoiseRouterDataTest.splineWithBlending(DensityFunctions.add(DensityFunctions.constant(-0.50375f), DensityFunctions.spline(TerrainProvider.overworldOffset(coordinate, coordinate2, coordinate4, bl))), DensityFunctions.blendOffset()));
        DensityFunction densityFunction3 = PresetNoiseRouterDataTest.registerAndWrap(bootstapContext, resourceKey2, PresetNoiseRouterDataTest.splineWithBlending(DensityFunctions.spline(TerrainProvider.overworldFactor(coordinate, coordinate2, coordinate3, coordinate4, bl)), BLENDING_FACTOR));
        DensityFunction densityFunction4 = PresetNoiseRouterDataTest.registerAndWrap(bootstapContext, resourceKey4, DensityFunctions.add(DensityFunctions.yClampedGradient(-64, 320, 1.5, -1.5), densityFunction2));
        DensityFunction densityFunction5 = PresetNoiseRouterDataTest.registerAndWrap(bootstapContext, resourceKey3, PresetNoiseRouterDataTest.splineWithBlending(DensityFunctions.spline(TerrainProvider.overworldJaggedness(coordinate, coordinate2, coordinate3, coordinate4, bl)), BLENDING_JAGGEDNESS));
        DensityFunction densityFunction6 = DensityFunctions.mul(densityFunction5, densityFunction.halfNegative());
        DensityFunction densityFunction7 = PresetNoiseRouterDataTest.noiseGradientDensity(densityFunction3, DensityFunctions.add(densityFunction4, densityFunction6));
        bootstapContext.register(resourceKey5, DensityFunctions.add(densityFunction7, PresetNoiseRouterDataTest.getFunction(holderGetter, BASE_3D_NOISE_OVERWORLD)));
    }
    ...
    public static DensityFunction entrances(HolderGetter<DensityFunction> holderGetter, HolderGetter<NormalNoise.NoiseParameters> holderGetter2) {
        ...
        DensityFunction densityFunction6 = PresetNoiseRouterDataTest.getFunction(holderGetter, SPAGHETTI_ROUGHNESS_FUNCTION);
    ...
    private static DensityFunction noodle(HolderGetter<DensityFunction> holderGetter, HolderGetter<NormalNoise.NoiseParameters> holderGetter2) {
        DensityFunction densityFunction = PresetNoiseRouterDataTest.getFunction(holderGetter, Y);
        int i = -64;
        int j = -60;
        int k = 320;
        DensityFunction densityFunction2 = PresetNoiseRouterDataTest.yLimitedInterpolatable(densityFunction, DensityFunctions.noise(holderGetter2.getOrThrow(Noises.NOODLE), 1.0, 1.0), -60, 320, -1);
        DensityFunction densityFunction3 = PresetNoiseRouterDataTest.yLimitedInterpolatable(densityFunction, DensityFunctions.mappedNoise(holderGetter2.getOrThrow(Noises.NOODLE_THICKNESS), 1.0, 1.0, -0.05, -0.1), -60, 320, 0);
        double d = 2.6666666666666665;
        DensityFunction densityFunction4 = PresetNoiseRouterDataTest.yLimitedInterpolatable(densityFunction, DensityFunctions.noise(holderGetter2.getOrThrow(Noises.NOODLE_RIDGE_A), 2.6666666666666665, 2.6666666666666665), -60, 320, 0);
        DensityFunction densityFunction5 = PresetNoiseRouterDataTest.yLimitedInterpolatable(densityFunction, DensityFunctions.noise(holderGetter2.getOrThrow(Noises.NOODLE_RIDGE_B), 2.6666666666666665, 2.6666666666666665), -60, 320, 0);
    ...
    private static DensityFunction spaghetti2D(HolderGetter<DensityFunction> holderGetter, HolderGetter<NormalNoise.NoiseParameters> holderGetter2) {
        ...
        DensityFunction densityFunction4 = PresetNoiseRouterDataTest.getFunction(holderGetter, SPAGHETTI_2D_THICKNESS_MODULATOR);
    ...
    public static DensityFunction underground(HolderGetter<DensityFunction> holderGetter, HolderGetter<NormalNoise.NoiseParameters> holderGetter2, DensityFunction densityFunction) {
        DensityFunction densityFunction2 = PresetNoiseRouterDataTest.getFunction(holderGetter, SPAGHETTI_2D);
        DensityFunction densityFunction3 = PresetNoiseRouterDataTest.getFunction(holderGetter, SPAGHETTI_ROUGHNESS_FUNCTION);
        ...
        DensityFunction densityFunction9 = DensityFunctions.min(DensityFunctions.min(densityFunction8, PresetNoiseRouterDataTest.getFunction(holderGetter, ENTRANCES)), DensityFunctions.add(densityFunction2, densityFunction3));
        DensityFunction densityFunction10 = PresetNoiseRouterDataTest.getFunction(holderGetter, PILLARS);
    ...
    protected static NoiseRouter overworld(HolderGetter<DensityFunction> holderGetter, HolderGetter<NormalNoise.NoiseParameters> holderGetter2, boolean bl, boolean bl2) {
        ...
        DensityFunction densityFunction5 = PresetNoiseRouterDataTest.getFunction(holderGetter, SHIFT_X);
        DensityFunction densityFunction6 = PresetNoiseRouterDataTest.getFunction(holderGetter, SHIFT_Z);
        ...
        DensityFunction densityFunction9 = PresetNoiseRouterDataTest.getFunction(holderGetter, bl ? FACTOR_LARGE : (bl2 ? FACTOR_AMPLIFIED : FACTOR));
        DensityFunction densityFunction10 = PresetNoiseRouterDataTest.getFunction(holderGetter, bl ? DEPTH_LARGE : (bl2 ? DEPTH_AMPLIFIED : DEPTH));
        DensityFunction densityFunction11 = PresetNoiseRouterDataTest.noiseGradientDensity(DensityFunctions.cache2d(densityFunction9), densityFunction10);
        DensityFunction densityFunction12 = PresetNoiseRouterDataTest.getFunction(holderGetter, bl ? SLOPED_CHEESE_LARGE : (bl2 ? SLOPED_CHEESE_AMPLIFIED : SLOPED_CHEESE));
        DensityFunction densityFunction13 = DensityFunctions.min(densityFunction12, DensityFunctions.mul(DensityFunctions.constant(5.0), PresetNoiseRouterDataTest.getFunction(holderGetter, ENTRANCES)));
        DensityFunction densityFunction14 = DensityFunctions.rangeChoice(densityFunction12, -1000000.0, 1.5625, densityFunction13, PresetNoiseRouterDataTest.underground(holderGetter, holderGetter2, densityFunction12));
        DensityFunction densityFunction15 = DensityFunctions.min(PresetNoiseRouterDataTest.postProcess(PresetNoiseRouterDataTest.slideOverworld(bl2, densityFunction14)), PresetNoiseRouterDataTest.getFunction(holderGetter, NOODLE));
        DensityFunction densityFunction16 = PresetNoiseRouterDataTest.getFunction(holderGetter, Y);
        ...
        DensityFunction densityFunction17 = PresetNoiseRouterDataTest.yLimitedInterpolatable(densityFunction16, DensityFunctions.noise(holderGetter2.getOrThrow(Noises.ORE_VEININESS), 1.5, 1.5), i, j, 0);
        float f = 4.0f;
        DensityFunction densityFunction18 = PresetNoiseRouterDataTest.yLimitedInterpolatable(densityFunction16, DensityFunctions.noise(holderGetter2.getOrThrow(Noises.ORE_VEIN_A), 4.0, 4.0), i, j, 0).abs();
        DensityFunction densityFunction19 = PresetNoiseRouterDataTest.yLimitedInterpolatable(densityFunction16, DensityFunctions.noise(holderGetter2.getOrThrow(Noises.ORE_VEIN_B), 4.0, 4.0), i, j, 0).abs();
    ...
    private static NoiseRouter noNewCaves(HolderGetter<DensityFunction> holderGetter, HolderGetter<NormalNoise.NoiseParameters> holderGetter2, DensityFunction densityFunction) {
        DensityFunction densityFunction2 = PresetNoiseRouterDataTest.getFunction(holderGetter, SHIFT_X);
        DensityFunction densityFunction3 = PresetNoiseRouterDataTest.getFunction(holderGetter, SHIFT_Z);
        ...
        DensityFunction densityFunction6 = PresetNoiseRouterDataTest.postProcess(densityFunction);
    ...
    private static DensityFunction slideOverworld(boolean bl, DensityFunction densityFunction) {
        return PresetNoiseRouterDataTest.slide(densityFunction, -64, 384, bl ? 16 : 80, bl ? 0 : 64, -0.078125, 0, 24, bl ? 0.4 : 0.1171875);
    }

    private static DensityFunction slideNetherLike(HolderGetter<DensityFunction> holderGetter, int i, int j) {
        return PresetNoiseRouterDataTest.slide(PresetNoiseRouterDataTest.getFunction(holderGetter, BASE_3D_NOISE_NETHER), i, j, 24, 0, 0.9375, -8, 24, 2.5);
    }

    private static DensityFunction slideEndLike(DensityFunction densityFunction, int i, int j) {
        return PresetNoiseRouterDataTest.slide(densityFunction, i, j, 72, -184, -23.4375, 4, 32, -0.234375);
    }
    ...
    protected static NoiseRouter nether(HolderGetter<DensityFunction> holderGetter, HolderGetter<NormalNoise.NoiseParameters> holderGetter2) {
        return PresetNoiseRouterDataTest.noNewCaves(holderGetter, holderGetter2, PresetNoiseRouterDataTest.slideNetherLike(holderGetter, 0, 128));
    }
    ...
    protected static NoiseRouter caves(HolderGetter<DensityFunction> holderGetter, HolderGetter<NormalNoise.NoiseParameters> holderGetter2) {
        return PresetNoiseRouterDataTest.noNewCaves(holderGetter, holderGetter2, PresetNoiseRouterDataTest.slideNetherLike(holderGetter, -64, 192));
    }
    ...
    protected static NoiseRouter floatingIslands(HolderGetter<DensityFunction> holderGetter, HolderGetter<NormalNoise.NoiseParameters> holderGetter2) {
        return PresetNoiseRouterDataTest.noNewCaves(holderGetter, holderGetter2, PresetNoiseRouterDataTest.slideEndLike(PresetNoiseRouterDataTest.getFunction(holderGetter, BASE_3D_NOISE_END), 0, 256));
    }

    private static DensityFunction slideEnd(DensityFunction densityFunction) {
        return PresetNoiseRouterDataTest.slideEndLike(densityFunction, 0, 128);
    }
    ...
    protected static NoiseRouter end(HolderGetter<DensityFunction> holderGetter) {
        ...
        DensityFunction densityFunction2 = PresetNoiseRouterDataTest.postProcess(PresetNoiseRouterDataTest.slideEnd(PresetNoiseRouterDataTest.getFunction(holderGetter, SLOPED_CHEESE_END)));
        return new NoiseRouter(DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero(), densityFunction, DensityFunctions.zero(), DensityFunctions.zero(), PresetNoiseRouterDataTest.slideEnd(DensityFunctions.add(densityFunction, DensityFunctions.constant(-0.703125))), densityFunction2, DensityFunctions.zero(), DensityFunctions.zero(), DensityFunctions.zero());
    }
