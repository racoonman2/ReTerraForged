...
public class PresetConfiguredCarvers {
	...
	private static float modifiedDeepCaveChance(CaveSettings caveSettings) {
		return caveSettings.legacyCarverDistribution ? 0.0F : caveSettings.deepCaveCarverChance;
	}
