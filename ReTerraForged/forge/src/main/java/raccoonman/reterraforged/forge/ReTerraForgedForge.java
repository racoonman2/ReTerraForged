...
import raccoonman.reterraforged.forge.data.provider.RTFClimateGroupTagsProvider;
...
public final class ReTerraForgedForge {
    ...
    private static void gatherData(GatherDataEvent event) {
    	...
    	builder.add(RTFRegistries.CLIMATE_GROUP, RTFClimateGroups::register);
    	...
    	generator.addProvider(includeServer, new RTFClimateGroupTagsProvider(output, lookupProvider, existingFileHelper));
