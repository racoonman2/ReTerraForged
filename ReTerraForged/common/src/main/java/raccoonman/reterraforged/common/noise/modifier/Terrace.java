...
public class Terrace extends Modifier {
	public static final Codec<Terrace> CODEC = RecordCodecBuilder.create(instance -> instance.group(
		...
		Noise.DIRECT_CODEC.fieldOf("ramp").forGetter((m) -> m.ramp),
		Noise.DIRECT_CODEC.fieldOf("cliff").forGetter((m) -> m.cliff),
		Noise.DIRECT_CODEC.fieldOf("ramp_height").forGetter((m) -> m.rampHeight),
